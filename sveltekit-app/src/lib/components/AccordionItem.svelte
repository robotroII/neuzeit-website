...
<style lang="css">
  ...
  details[open] summary ~ .accordion-collapse {
    animation: open 400ms cubic-bezier(0.55, 0, 0.1, 1)
  }

  /* closing class */
  details.is-closing summary ~ .accordion-collapse {
    animation: close 300ms cubic-bezier(0.55, 0, 0.1, 1)
  }
</style>
